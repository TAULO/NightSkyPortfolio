...
function getScreenPosition(altitudeDeg, azimuthDeg, containerWidth, containerHeight) {
...
function updateBodyPosition(bodyName, altitude, azimuth) {
    ...
    // Debug info
    console.log(`${bodyName}: ${altitude}° alt, ${azimuth}° az → screen (${pos.x.toFixed(1)}, ${pos.y.toFixed(1)})`);
}
