  ...
  return (
    <>
      <div className={'sm:my-15 fixed left-1/2 z-10 my-10 -translate-x-1/2'}>
        <div
          className={
            'bg-menu backdrop-grayscale-25 flex items-center gap-5 text-ellipsis whitespace-nowrap rounded-2xl border border-[rgba(62,71,137,0.3)] px-5 py-3 text-[.55rem] font-semibold text-white shadow sm:gap-10 sm:text-sm 2xl:text-sm'
          }
        >
