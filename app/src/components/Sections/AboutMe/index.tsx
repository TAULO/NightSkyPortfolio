  ...
  <div className={'flex flex-col gap-4 sm:flex-row sm:gap-8'}>
    ...
    <div className={'flex flex-col gap-4'}>
      ...
      <p className={'leading-7 text-white/75'}>
        ...
        administrative systems. On my own time, I'm drawn to frontend work, but
        I try not to get too comfortable with any single stack. I'd rather pick
        up something unfamiliar than reach for the same tool every time.
      </p>
      <p className={'leading-7 text-white/75'}>
